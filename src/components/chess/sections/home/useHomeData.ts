...
const fullRussiaRanking: LeaderboardPlayer[] = [
  { rank: 1, name: "Евгения Малыхина", rating: 2456, city: "Москва", avatar: "https://api.dicebear.com/7.x/avataaars/svg?seed=Alexander" },
  { rank: 2, name: "Костя Шапран", rating: 2398, city: "Санкт-Петербург", avatar: "https://api.dicebear.com/7.x/avataaars/svg?seed=Maria" },
  { rank: 3, name: "Владик Гурин", rating: 2356, city: "Казань", avatar: "https://api.dicebear.com/7.x/avataaars/svg?seed=Dmitry" },
  { rank: 4, name: "Жена Севрюгин", rating: 2287, city: "Екатеринбург", avatar: "https://api.dicebear.com/7.x/avataaars/svg?seed=Elena" },
...
function buildRegionRanking(userCity: string): LeaderboardPlayer[] {
  return [
    { rank: 1, name: "Юлька Акапулька", rating: 2123, city: userCity, avatar: "https://api.dicebear.com/7.x/avataaars/svg?seed=Igor" },
    { rank: 2, name: "Оля Михалковская", rating: 2089, city: userCity === "Москва" ? "Подольск" : userCity, avatar: "https://api.dicebear.com/7.x/avataaars/svg?seed=Anna" },
    ...
    { rank: 4, name: "Настя Бессонова", rating: 1998, city: userCity === "Москва" ? "Химки" : userCity, avatar: "https://api.dicebear.com/7.x/avataaars/svg?seed=Olga" },
...
function buildCityRanking(userCity: string, userAvatar: string): LeaderboardPlayer[] {
  return [
...
export function useHomeData() {
  ...
  const [realLeaderboard, setRealLeaderboard] = useState<LeaderboardData | null>(null);
  ...
  const activeRegionRanking = isRealMode ? realLeaderboard.region : buildRegionRanking(userCity);
  const activeCityRanking = isRealMode ? realLeaderboard.city : buildCityRanking(userCity, userAvatar);
