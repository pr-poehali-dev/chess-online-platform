...
const levels = [
  ...
  },
  {
    ...
    delay: '5 секунд',
    skills: [
      'Анализирует половину доступных ходов (случайная выборка)',
      'Просчитывает позицию на 3 хода вперёд',
      'Иногда делает неоптимальные ходы из-за шума в оценке',
      'Может брать незащищённые фигуры и ставить простые угрозы',
      'Хорошо подходит для любителей',
    ],
  },
  {
    emoji: '🟠',
    ...
    delay: '4 секунды',
    skills: [
      'Анализирует все доступные ходы с приоритетом захватов и угроз',
      'Просчитывает позицию на 3 хода вперёд (минимакс + альфа-бета)',
      'Небольшой шум в оценке — иногда выбирает не лучший ход',
  ...
  },
  {
    ...
    delay: '2 секунды',
    skills: [
      'Анализирует все ходы на глубину 5 уровней вперёд',
