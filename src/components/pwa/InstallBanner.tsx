            ...
            {canPrompt ? (
              ...
              <div className="space-y-2">
                <a
                  ...
                  className="flex items-center justify-center gap-2 bg-green-600 hover:bg-green-700 text-white font-bold text-sm py-2.5 rounded-xl transition-colors w-full"
                >
                  <Icon name="Chrome" size={18} fallback="ExternalLink" />
                  Открыть в Chrome и установить
                </a>
                <div className="text-[11px] text-gray-500 text-center">
                  В Chrome установка работает в одно нажатие
                </div>
              </div>
            )}
          </div>
